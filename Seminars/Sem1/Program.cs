...
// Запросить значение переменной с помощью метода Console.ReadLine. Вычислить квадрат числа.
...
// Написать программу, которая на вход принимает два целых числа. Вычислить является ли первое число квадратом второго.
...
//  Написать программу, которая на вход принимает целое положительное число N, а на выходе показывает все целые числа от -N до N.
...
//  Напишите программу, которая принимает на вход трехзначное целое число и на выходе показывает сумму первой
